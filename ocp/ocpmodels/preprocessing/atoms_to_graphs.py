...
class AtomsToGraphs:
    ...
    def _get_neighbors_pymatgen(self, atoms: Union[ase.Atoms, pymatgen.core.structure.Structure]):
        ...
        if isinstance(atoms, ase.Atoms):
            ...
            struct = atoms
        """
        The returned values are a tuple of numpy arrays (center_indices, points_indices, offset_vectors, distances). 
        Atom center_indices[i] has neighbor atom points_indices[i] that is translated by offset_vectors[i] lattice vectors
